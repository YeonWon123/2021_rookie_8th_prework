...
public class UploadController {
    ...
    // URL 인코딩된 파일 이름을 파라미터로 받아서, 해당 파일을 byte[]로 만들어서 브라우저로 전송함
    // 파일의 확장자에 따라서 브라우저에 전송하는 MINE 타입이 달라져야 하는 문제 : java.nio.file 패키지의 Files.probeContentType()을 이용하여 처리
    ...
    // 경로와 UUID가 포함된 파일 이름을 파라미터로 받아, 삭제 결과를 Boolean 타입으로 만들어서 전송
    // 원본 파일과 함께 섬네일 파일도 같이 삭제해야 함
